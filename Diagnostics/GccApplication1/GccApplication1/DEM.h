...
Std_ReturnType Dem_GetDTCOfEvent(Dem_EventIdType eventId, uint32* dtcOfEvent); /** @req DEM198 */
 ...
 */
Dem_ReturnClearDTCType Dem_ClearDTC(uint32 dtc, Dem_DTCOriginType dtcOrigin); /** @req DEM241 */
Dem_ReturnSetDTCFilterType Dem_SetDTCFilter(uint8 dtcStatusMask);  /** @req DEM208 */
Dem_ReturnGetStatusOfDTCType Dem_GetStatusOfDTC(uint32 dtc, Dem_EventStatusExtendedType* status); /** @req DEM212 */
...
Dem_ReturnControlDTCStorageType Dem_DisableDTCStorage(Dem_DTCGroupType dtcGroup); /** @req DEM242 */
Dem_ReturnControlDTCStorageType Dem_EnableDTCStorage(Dem_DTCGroupType dtcGroup); /** @req DEM243 */
...
Dem_ReturnGetSizeOfExtendedDataRecordByDTCType Dem_GetSizeOfExtendedDataecordByDTC(uint32 dtc, uint8 extendedDataNumber, uint16 *sizeOfExtendedDataRecord); /** @req DEM240 */
