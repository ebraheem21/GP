...
#define DEM_MAX_NUMBER_EVENT				3
#define DEM_MAX_NUMBER_EXT_DATA_PRE_INIT	20
#define DEM_MAX_NUMBER_FF_DATA_PRE_INIT 	20
#define DEM_MAX_NUMBER_EVENT_PRI_MEM		DEM_MAX_NUMBER_EVENT
#define DEM_MAX_NUMBER_FF_DATA_PRI_MEM 		3
#define DEM_MAX_NUMBER_EXT_DATA_PRI_MEM		5
#define DEM_MAX_NR_OF_EVENT_DESTINATION		1
#define DEM_MAX_NUMBER_EVENT_ENTRY_PRI      DEM_MAX_NUMBER_EVENT
#define DEM_FREEZEFRAME_DEFAULT_VALUE 		1
#define DEM_DID_IDENTIFIER_SIZE_OF_BYTES 	2
#define DEM_MAX_SIZE_FF_DATA                20
#define DEM_DTC_STATUS_AVAILABILITY_MASK    0x7F
...
#define DEM_EVENT_DESTINATION_END_OF_LIST 4
 ...
 * Dem status type
 */
#define DEM_DTC_STATUS_MASK_ALL			(uint8)0xff
